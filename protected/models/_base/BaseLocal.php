...
abstract class BaseLocal extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('entel, movistar', 'length', 'max'=>10),
			array('user_id, ciudad, direccion, telefono, nombre, entel, movistar', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, user_id, ciudad, direccion, telefono, nombre, entel, movistar', 'safe', 'on'=>'search'),
		);
	}
